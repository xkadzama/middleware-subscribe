...
@reserve.message(HotelState.waiting_for_name)
...
@reserve.message(HotelState.waiting_for_room)
...
@reserve.message(HotelState.waiting_for_date)
...
@reserve.message(HotelState.waiting_for_phone)
...
@reserve.callback_query(F.data == 'okey')
